...
//  GHFollowers
//
//  Created by Frank Su on 2021-06-22.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createFavouriteNavController() -> UINavigationController {
        let favNC = UINavigationController(rootViewController: FavouriteViewController())
        favNC.title = "Favourite"
    ...
    func createTabBarController() -> UITabBarController {
        ...
        tabBarController.viewControllers = [createSearchNavController(), createFavouriteNavController()]
